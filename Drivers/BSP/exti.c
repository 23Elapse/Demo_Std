...
GPIO_Config_TypeDef gpio_configs[] = {
    { RCC_AHB1Periph_GPIOH, KEY0_INT_GPIO_PORT, KEY0_INT_GPIO_PIN, GPIO_Mode_IN, GPIO_OType_PP, GPIO_PuPd_UP, GPIO_High_Speed},
    { RCC_AHB1Periph_GPIOH, KEY1_INT_GPIO_PORT, KEY1_INT_GPIO_PIN, GPIO_Mode_IN, GPIO_OType_PP, GPIO_PuPd_UP, GPIO_High_Speed},
    { RCC_AHB1Periph_GPIOC, KEY2_INT_GPIO_PORT, KEY2_INT_GPIO_PIN, GPIO_Mode_IN, GPIO_OType_PP, GPIO_PuPd_UP, GPIO_High_Speed},
    { RCC_AHB1Periph_GPIOA, WKUP_INT_GPIO_PORT, WKUP_INT_GPIO_PIN, GPIO_Mode_IN, GPIO_OType_PP, GPIO_PuPd_DOWN, GPIO_High_Speed}
};
