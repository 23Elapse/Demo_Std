 ...
 * @LastEditTime: 2025-04-30 14:46:38
...
#define AP_INT_IO                          1       /* AP3216C 中断引脚      P1 */
#define DCMI_PWDN_IO                       2       /* DCMI 电源控制引脚     P2 */
#define USB_PWR_IO                         3       /* USB 电源控制引脚      P3 */
#define EX_IO                              4       /* 扩展 IO，自定义使用   P4 */
#define MPU_INT_IO                         5       /* SH3001 中断引脚       P5 */
#define RS485_RE_IO                        6       /* RS485_RE 引脚         P6 */
#define ETH_RESET_IO                       7       /* 以太网复位引脚        P7 */

/******************************************************************************************/

/* 全局变量声明 */
extern const IIC_Ops_t IIC1_PCF8574; /* IIC 操作接口结构体 */
